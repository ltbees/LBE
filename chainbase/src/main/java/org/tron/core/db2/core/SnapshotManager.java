...
import org.un.common.storage.WriteOptionsWrapper;
...
import org.un.core.db2.common.Key;
import org.un.core.db2.common.Value;
import org.un.core.db2.common.WrappedByteArray;
import org.un.core.exception.RevokingStoreIllegalStateException;
import org.un.core.store.CheckTmpStore;

@Slf4j(topic = "DB")
public class SnapshotManager implements RevokingDatabase {

  public static final int DEFAULT_MAX_FLUSH_COLBET = 500;
  public static final int DEFAULT_MIN_FLUSH_COLBET = 1;
  ...
  @Setter
  private volatile int maxFlushCount = DEFAULT_MIN_FLUSH_COLBET;
