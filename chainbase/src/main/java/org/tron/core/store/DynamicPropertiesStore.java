...
import org.un.core.config.Parameter;
import org.un.core.config.Parameter.ChainConstant;
import org.un.core.db.LbeStoreWithRevoking;

@Slf4j(topic = "DB")
@Component
public class DynamicPropertiesStore extends LbeStoreWithRevoking<BytesCapsule> {
  ...
  private static final byte[] ACCOLBET_UPGRADE_COST = "ACCOLBET_UPGRADE_COST".getBytes();
  ...
  //abandon
  private static final byte[] CREATE_ACCOLBET_FEE = "CREATE_ACCOLBET_FEE".getBytes();
  private static final byte[] CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT
      = "CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT".getBytes();
  private static final byte[] CREATE_NEW_ACCOLBET_BANDWIDTH_RATE =
      "CREATE_NEW_ACCOLBET_BANDWIDTH_RATE"
          .getBytes();
  ...
  private static final byte[] UPDATE_ACCOLBET_PERMISSION_FEE = "UPDATE_ACCOLBET_PERMISSION_FEE"
      .getBytes();
  ...
  private static final byte[] SHIELDED_TRANSACTION_CREATE_ACCOLBET_FEE =
      "SHIELDED_TRANSACTION_CREATE_ACCOLBET_FEE".getBytes();
  ...
  private static final byte[] TOTAL_CREATE_ACCOLBET_COST = "TOTAL_CREATE_ACCOLBET_COST".getBytes();
  ...
  //This value is only allowed to be 0, 1, -1
  private static final byte[] ALLOW_UPDATE_ACCOLBET_NAME = "ALLOW_UPDATE_ACCOLBET_NAME".getBytes();
  //This value is only allowed to be 0, 1, -1
  ...
  private static final byte[] ALLOW_ACCOLBET_STATE_ROOT = "ALLOW_ACCOLBET_STATE_ROOT".getBytes();
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      ...
      this.saveCreateAccountFee(100_000L); // 0.1LBE
    }
  ...
  public long getTokenIdNum() {
    return Optional.ofNullable(getLbechecked(TOKEN_ID_NUM))
  ...
  public long getTokenUpdateDone() {
    return Optional.ofNullable(getLbechecked(TOKEN_UPDATE_DONE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public int getBlockFilledSlotsIndex() {
    return Optional.ofNullable(getLbechecked(BLOCK_FILLED_SLOTS_INDEX))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getMaxFrozenTime() {
    return Optional.ofNullable(getLbechecked(MAX_FROZEN_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getMinFrozenTime() {
    return Optional.ofNullable(getLbechecked(MIN_FROZEN_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getMaxFrozenSupplyNumber() {
    return Optional.ofNullable(getLbechecked(MAX_FROZEN_SUPPLY_NUMBER))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getMaxFrozenSupplyTime() {
    return Optional.ofNullable(getLbechecked(MAX_FROZEN_SUPPLY_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getMinFrozenSupplyTime() {
    return Optional.ofNullable(getLbechecked(MIN_FROZEN_SUPPLY_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public int getWitnessAllowanceFrozenTime() {
    return Optional.ofNullable(getLbechecked(WITNESS_ALLOWANCE_FROZEN_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public long getMaintenanceTimeInterval() {
    return Optional.ofNullable(getLbechecked(MAINTENANCE_TIME_INTERVAL))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public void saveAccountUpgradeCost(long accountUpgradeCost) {
    logger.debug("ACCOLBET_UPGRADE_COST:" + accountUpgradeCost);
    this.put(ACCOLBET_UPGRADE_COST,
        new BytesCapsule(ByteArray.fromLong(accountUpgradeCost)));
  }

  public long getAccountUpgradeCost() {
    return Optional.ofNullable(getLbechecked(ACCOLBET_UPGRADE_COST))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ACCOLBET_UPGRADE_COST"));
  }
  ...
  public long getWitnessPayPerBlock() {
    return Optional.ofNullable(getLbechecked(WITNESS_PAY_PER_BLOCK))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getWitness127PayPerBlock() {
    return Optional.ofNullable(getLbechecked(WITNESS_127_PAY_PER_BLOCK))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElse(16000000L);
  }
  ...
  public long getWitnessStandbyAllowance() {
    return Optional.ofNullable(getLbechecked(WITNESS_STANDBY_ALLOWANCE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getOneDayNetLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.ONE_DAY_NET_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getPublicNetUsage() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.PUBLIC_NET_USAGE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getPublicNetLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.PUBLIC_NET_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getPublicNetTime() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.PUBLIC_NET_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getFreeNetLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.FREE_NET_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalNetWeight() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_NET_WEIGHT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyWeight() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_WEIGHT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalNetLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_NET_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyCurrentLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_CURRENT_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyTargetLimit() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_TARGET_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyAverageUsage() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_AVERAGE_USAGE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAdaptiveResourceLimitMultiplier() {
    return Optional
        .ofNullable(getLbechecked(DynamicResourceProperties.ADAPTIVE_RESOURCE_LIMIT_MULTIPLIER))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAdaptiveResourceLimitTargetRatio() {
    return Optional
        .ofNullable(getLbechecked(DynamicResourceProperties.ADAPTIVE_RESOURCE_LIMIT_TARGET_RATIO))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalEnergyAverageTime() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.TOTAL_ENERGY_AVERAGE_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getBlockEnergyUsage() {
    return Optional.ofNullable(getLbechecked(DynamicResourceProperties.BLOCK_ENERGY_USAGE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getEnergyFee() {
    return Optional.ofNullable(getLbechecked(ENERGY_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getMaxCpuTimeOfOneTx() {
    return Optional.ofNullable(getLbechecked(MAX_CPU_TIME_OF_ONE_TX))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public void saveCreateAccountFee(long fee) {
    this.put(CREATE_ACCOLBET_FEE,
        new BytesCapsule(ByteArray.fromLong(fee)));
  }

  public long getShieldedTransactionCreateAccountFee() {
    return Optional.ofNullable(getLbechecked(SHIELDED_TRANSACTION_CREATE_ACCOLBET_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(
                "not found SHIELDED_TRANSACTION_CREATE_ACCOLBET_FEE"));
  }

  public void saveShieldedTransactionCreateAccountFee(long fee) {
    this.put(SHIELDED_TRANSACTION_CREATE_ACCOLBET_FEE,
        new BytesCapsule(ByteArray.fromLong(fee)));
  }

  public long getShieldedTransactionFee() {
    return Optional.ofNullable(getLbechecked(SHIELDED_TRANSACTION_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalShieldedPoolValue() {
    return Optional.ofNullable(getLbechecked(TOTAL_SHIELDED_POOL_VALUE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getCreateAccountFee() {
    return Optional.ofNullable(getLbechecked(CREATE_ACCOLBET_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found CREATE_ACCOLBET_FEE"));
  }

  public void saveCreateNewAccountFeeInSystemContract(long fee) {
    this.put(CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT,
        new BytesCapsule(ByteArray.fromLong(fee)));
  }

  public long getCreateNewAccountFeeInSystemContract() {
    return Optional.ofNullable(getLbechecked(CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(
                "not found CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT"));
  }

  public void saveCreateNewAccountBandwidthRate(long rate) {
    this.put(CREATE_NEW_ACCOLBET_BANDWIDTH_RATE,
        new BytesCapsule(ByteArray.fromLong(rate)));
  }

  public long getCreateNewAccountBandwidthRate() {
    return Optional.ofNullable(getLbechecked(CREATE_NEW_ACCOLBET_BANDWIDTH_RATE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(
                "not found CREATE_NsEW_ACCOLBET_BANDWIDTH_RATE2"));
  }
  ...
  public long getTransactionFee() {
    return Optional.ofNullable(getLbechecked(TRANSACTION_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public void saveUpdateAccountPermissionFee(long fee) {
    this.put(UPDATE_ACCOLBET_PERMISSION_FEE,
        new BytesCapsule(ByteArray.fromLong(fee)));
  }
  ...
  public long getAssetIssueFee() {
    return Optional.ofNullable(getLbechecked(ASSET_ISSUE_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getUpdateAccountPermissionFee() {
    return Optional.ofNullable(getLbechecked(UPDATE_ACCOLBET_PERMISSION_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found UPDATE_ACCOLBET_PERMISSION_FEE"));
  }

  public long getMultiSignFee() {
    return Optional.ofNullable(getLbechecked(MULTI_SIGN_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getExchangeCreateFee() {
    return Optional.ofNullable(getLbechecked(EXCHANGE_CREATE_FEE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getExchangeBalanceLimit() {
    return Optional.ofNullable(getLbechecked(EXCHANGE_BALANCE_LIMIT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalTransactionCost() {
    return Optional.ofNullable(getLbechecked(TOTAL_TRANSACTION_COST))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public void saveTotalCreateAccountFee(long value) {
    this.put(TOTAL_CREATE_ACCOLBET_COST,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getTotalCreateAccountCost() {
    return Optional.ofNullable(getLbechecked(TOTAL_CREATE_ACCOLBET_COST))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found TOTAL_CREATE_ACCOLBET_COST"));
  }
  ...
  public long getTotalCreateWitnessCost() {
    return Optional.ofNullable(getLbechecked(TOTAL_CREATE_WITNESS_COST))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalStoragePool() {
    return Optional.ofNullable(getLbechecked(TOTAL_STORAGE_POOL))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalStorageTax() {
    return Optional.ofNullable(getLbechecked(TOTAL_STORAGE_TAX))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getTotalStorageReserved() {
    return Optional.ofNullable(getLbechecked(TOTAL_STORAGE_RESERVED))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getStorageExchangeTaxRate() {
    return Optional.ofNullable(getLbechecked(STORAGE_EXCHANGE_TAX_RATE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getRemoveThePowerOfTheGr() {
    return Optional.ofNullable(getLbechecked(REMOVE_THE_POWER_OF_THE_GR))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowDelegateResource() {
    return Optional.ofNullable(getLbechecked(ALLOW_DELEGATE_RESOURCE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowAdaptiveEnergy() {
    return Optional.ofNullable(getLbechecked(ALLOW_ADAPTIVE_ENERGY))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowTvmTransferTrc10() {
    return Optional.ofNullable(getLbechecked(ALLOW_TVM_TRANSFER_TRC10))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowTvmConstantinople() {
    return Optional.ofNullable(getLbechecked(ALLOW_TVM_CONSTANTINOPLE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowTvmSolidity059() {
    return Optional.ofNullable(getLbechecked(ALLOW_TVM_SOLIDITY_059))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
  ...
  public long getForbidTransferToContract() {
    return Optional.ofNullable(getLbechecked(FORBID_TRANSFER_TO_CONTRACT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
  ...
  public byte[] getAvailableContractType() {
    return Optional.ofNullable(getLbechecked(AVAILABLE_CONTRACT_TYPE))
        .map(BytesCapsule::getData)
        .orElseThrow(
  ...
  public byte[] getActiveDefaultOperations() {
    return Optional.ofNullable(getLbechecked(ACTIVE_DEFAULT_OPERATIONS))
        .map(BytesCapsule::getData)
        .orElseThrow(
  ...
  public void saveAllowUpdateAccountName(long rate) {
    this.put(ALLOW_UPDATE_ACCOLBET_NAME,
        new BytesCapsule(ByteArray.fromLong(rate)));
  }

  public long getAllowUpdateAccountName() {
    return Optional.ofNullable(getLbechecked(ALLOW_UPDATE_ACCOLBET_NAME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_UPDATE_ACCOLBET_NAME"));
  }
  ...
  public long getAllowSameTokenName() {
    return Optional.ofNullable(getLbechecked(ALLOW_SAME_TOKEN_NAME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public int getTotalSignNum() {
    return Optional.ofNullable(getLbechecked(TOTAL_SIGN_NUM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
        .orElseThrow(
  ...
  public long getAllowMultiSign() {
    return Optional.ofNullable(getLbechecked(ALLOW_MULTI_SIGN))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowCreationOfContracts() {
    return Optional.ofNullable(getLbechecked(ALLOW_CREATION_OF_CONTRACTS))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getAllowShieldedTransaction() {
    return Optional.ofNullable(getLbechecked(ALLOW_SHIELDED_TRANSACTION))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public int[] getBlockFilledSlots() {
    return Optional.ofNullable(getLbechecked(BLOCK_FILLED_SLOTS))
        .map(BytesCapsule::getData)
        .map(ByteArray::toStr)
  ...
  public long getLatestSolidifiedBlockNum() {
    return Optional.ofNullable(getLbechecked(LATEST_SOLIDIFIED_BLOCK_NUM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getLatestProposalNum() {
    return Optional.ofNullable(getLbechecked(LATEST_PROPOSAL_NUM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getLatestExchangeNum() {
    return Optional.ofNullable(getLbechecked(LATEST_EXCHANGE_NUM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getLatestBlockHeaderTimestamp() {
    return Optional.ofNullable(getLbechecked(LATEST_BLOCK_HEADER_TIMESTAMP))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public long getLatestBlockHeaderNumber() {
    return Optional.ofNullable(getLbechecked(LATEST_BLOCK_HEADER_NUMBER))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public int getStateFlag() {
    return Optional.ofNullable(getLbechecked(STATE_FLAG))
        .map(BytesCapsule::getData)
        .map(ByteArray::toInt)
  ...
  public Sha256Hash getLatestBlockHeaderHash() {
    byte[] blockHash = Optional.ofNullable(getLbechecked(LATEST_BLOCK_HEADER_HASH))
        .map(BytesCapsule::getData)
  ...
  public long getNextMaintenanceTime() {
    return Optional.ofNullable(getLbechecked(NEXT_MAINTENANCE_TIME))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
  ...
  public byte[] statsByVersion(int version) {
    String statsKey = FORK_PREFIX + version;
    return revokingDB.getLbechecked(statsKey.getBytes());
  }

  public boolean getForked() {
    byte[] value = revokingDB.getLbechecked(FORK_CONTROLLER);
  ...
  public long getAllowProtoFilterNum() {
    return Optional.ofNullable(getLbechecked(ALLOW_PROTO_FILTER_NUM))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
  ...
  public void saveAllowAccountStateRoot(long allowAccountStateRoot) {
    this.put(ALLOW_ACCOLBET_STATE_ROOT,
        new BytesCapsule(ByteArray.fromLong(allowAccountStateRoot)));
  }

  public long getAllowAccountStateRoot() {
    return Optional.ofNullable(getLbechecked(ALLOW_ACCOLBET_STATE_ROOT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_ACCOLBET_STATE_ROOT"));
  }
  ...
  public long getCurrentCycleNumber() {
    return Optional.ofNullable(getLbechecked(CURRENT_CYCLE_NUMBER))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElse(0L);
  }
  ...
  public long getChangeDelegation() {
    return Optional.ofNullable(getLbechecked(CHANGE_DELEGATION))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
  ...
  public long getAllowPBFT() {
    return Optional.ofNullable(getLbechecked(ALLOW_PBFT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
