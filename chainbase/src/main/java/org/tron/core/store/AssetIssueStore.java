...
import static org.un.common.utils.Commons.ASSET_ISSUE_COLBET_LIMIT_MAX;
...
@Slf4j(topic = "DB")
@Component
public class AssetIssueStore extends LbeStoreWithRevoking<AssetIssueCapsule> {
...
//        .skip(offset)
//        .limit(Math.min(limit, ASSET_ISSUE_COLBET_LIMIT_MAX))
//        .collect(Collectors.toList());
    ...
    limit = limit > ASSET_ISSUE_COLBET_LIMIT_MAX ? ASSET_ISSUE_COLBET_LIMIT_MAX : limit;
