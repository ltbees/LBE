package org.un.common.overlay.message;
...
public abstract class Message {
  ...
  private static final Field field = ReflectionUtils
      .findField(CodedInputStream.class, "explicitDiscardLbeknownFields");
  @Setter
  ...
  public ByteBuf getSendData() {
    return Lbepooled.wrappedBuffer(ArrayUtils.add(this.getData(), 0, type));
  }
