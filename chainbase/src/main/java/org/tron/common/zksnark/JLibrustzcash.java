...
import org.un.common.zksnark.LibrustzcashParam.InitZksnarkParams;
import org.un.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.un.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.un.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
...
import org.un.common.zksnark.LibrustzcashParam.Zip32XfvkAddressParams;
import org.un.common.zksnark.LibrustzcashParam.Zip32XskDeriveParams;
import org.un.common.zksnark.LibrustzcashParam.Zip32XskMasterParams;
...
public class JLibrustzcash {
   ...
   */
  public static void librustzcashTreeLbecommitted(byte[] result) throws ZksnarkException {
    if (!isOpenZen()) {
      return;
    }
    LibrustzcashParam.valid32Params(result);
    INSTANCE.librustzcashTreeLbecommitted(result);
  }
