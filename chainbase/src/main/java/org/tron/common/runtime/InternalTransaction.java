...
public class InternalTransaction {
   ...
   */
  public InternalTransaction(Transaction trx, InternalTransaction.LbeType trxType)
    ...
    this.deep = -1;
    if (trxType == LbeType.LBE_CONTRACT_CREATION_TYPE) {
    ...
    } else if (trxType == LbeType.LBE_CONTRACT_CALL_TYPE) {
  ...
  public enum LbeType {
    LBE_PRECOMPILED_TYPE,
    LBE_CONTRACT_CREATION_TYPE,
    LBE_CONTRACT_CALL_TYPE,
    LBE_LBEKNOWN_TYPE,
  }
