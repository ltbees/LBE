...
public class Constant {
  ...
  public static final long MAXIMUM_TIME_LBETIL_EXPIRATION = 24 * 60 * 60 * 1_000L; //one day
  public static final long TRANSACTION_DEFAULT_EXPIRATION_TIME = 60 * 1_000L; //60 seconds
  // config for smart contract
  public static final long SLBE_PER_ENERGY = 100; // 1 us = 100 SLBE = 100 * 10^-6 LBE
  ...
  // Numbers
  public static final int ONE_HLBEDRED = 100;
  public static final int ONE_THOUSAND = 1000;

  public static final byte[] ZLBE_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final int LBEEXECUTEDDEFERREDTRANSACTION = 1;
  ...
  public static final String LOCAL_WITNESS_ACCOLBET_ADDRESS = "localWitnessAccountAddress";
  ...
  public static final String VM_LONG_RLBENING_TIME = "vm.longRunningTime";
  ...
  public static final String NODE_NET_MAX_LBE_PER_SECOND = "node.netMaxLbePerSecond";
  ...
  public static final String LBE_REFERENCE_BLOCK = "trx.reference.block";

  public static final String LBE_EXPIRATION_TIME_IN_MILLIS_SECONDS = "trx.expiration.timeInMilliseconds";
  ...
  public static final String COMMITTEE_ALLOW_ACCOLBET_STATE_ROOT = "committee.allowAccountStateRoot";
  ...
  public static final String NODE_SHIELDED_TRANS_IN_PENDING_MAX_COLBETS = "node.shieldedTransInPendingMaxCounts";
