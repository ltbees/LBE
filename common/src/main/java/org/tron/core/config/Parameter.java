...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] LBE_SYMBOL_BYTES = "_".getBytes(); // LBE symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long LBE_PRECISION = 1000_000L;
  }
  ...
  public class NetConstants {
    ...
    public static final long NET_MAX_LBE_PER_SECOND = 700L;
    public static final int MSG_CACHE_DURATION_IN_BLOCKS = 5;
    public static final int MAX_BLOCK_FETCH_PER_PEER = 100;
    public static final int MAX_LBE_FETCH_PER_PEER = 1000;
  }

  public class DatabaseConstants {

    public static final int TRANSACTIONS_COLBET_LIMIT_MAX = 1000;
    public static final int PROPOSAL_COLBET_LIMIT_MAX = 1000;
    public static final int EXCHANGE_COLBET_LIMIT_MAX = 1000;
  }
