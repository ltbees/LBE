...
public class Account implements Serializable {
  ...
  private static final String ACCOLBET_TYPE_NORMAL = "NORMAL";
  private static final String ACCOLBET_TYPE_ASSETISSUE = "ASSETISSUE";
  private static final String ACCOLBET_TYPE_CONTRACT = "CONTRACT";
...
//  }
  ...
  public boolean isAccountType(final String accountType) {
    ...
    switch (accountType.toUpperCase()) {
      case ACCOLBET_TYPE_NORMAL:
      case ACCOLBET_TYPE_ASSETISSUE:
      case ACCOLBET_TYPE_CONTRACT:
        return true;
      default:
        return false;
    }
