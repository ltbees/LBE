package org.un.common.parameter;
...
import org.un.core.config.args.Overlay;
import org.un.core.config.args.SeedNode;
import org.un.core.config.args.Storage;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-un or not.(true or false)")
  ...
  //If you are running a solidity node for java un, this flag is set to true
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long netMaxLbePerSecond;
  @Getter
  @Setter
