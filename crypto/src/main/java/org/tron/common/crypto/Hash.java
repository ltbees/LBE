...
public class Hash {
  ...
  private static final String ALGORITHM_NOT_FOLBED = "Can't find such algorithm";
  /**
  ...
  static {
    Security.addProvider(LbeCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("SC");
    HASH_256_ALGORITHM_NAME = "LBE-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "LBE-KECCAK-512";
  ...
  public static byte[] sha3(byte[] input) {
    ...
    try {
      ...
      logger.error(ALGORITHM_NOT_FOLBED, e);
