...
import org.un.common.crypto.jce.ECKeyAgreement;
import org.un.common.crypto.jce.ECKeyFactory;
import org.un.common.crypto.jce.ECKeyPairGenerator;
import org.un.common.crypto.jce.ECSignatureFactory;
import org.un.common.crypto.jce.LbeCastleProvider;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(LbeCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = LbeCastleProvider.getInstance();
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(LbeCastleProvider.getInstance())
  ...
  /**
   * Produce a string rendering of the ECKey INCLUDING the private key. Lbeless you absolutely need
