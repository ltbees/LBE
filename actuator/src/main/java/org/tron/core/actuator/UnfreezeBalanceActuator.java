...
import static org.un.core.config.Parameter.ChainConstant.LBE_PRECISION;
...
import org.un.core.db.DelegationService;
...
import org.un.protos.Protocol.Account.AccountResource;
...
public class LbefreezeBalanceActuator extends AbstractActuator {

  public LbefreezeBalanceActuator() {
    super(ContractType.LbefreezeBalanceContract, LbefreezeBalanceContract.class);
  }
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    long fee = calcFee();
    final LbefreezeBalanceContract unfreezeBalanceContract;
    ...
    try {
      unfreezeBalanceContract = any.unpack(LbefreezeBalanceContract.class);
    ...
    switch (unfreezeBalanceContract.getResource()) {
      case BANDWIDTH:
        dynamicStore
            .addTotalNetWeight(-unfreezeBalance / LBE_PRECISION);
        break;
      case ENERGY:
        dynamicStore
            .addTotalEnergyWeight(-unfreezeBalance / LBE_PRECISION);
        break;
      default:
        //this should never happen
        break;
    ...
    ret.setLbefreezeAmount(unfreezeBalance);
  ...
  public boolean validate() throws ContractValidateException {
    ...
    DynamicPropertiesStore dynamicStore = chainBaseManager.getDynamicPropertiesStore();
    DelegatedResourceStore delegatedResourceStore = chainBaseManager.getDelegatedResourceStore();
    if (!this.any.is(LbefreezeBalanceContract.class)) {
      throw new ContractValidateException(
          "contract type error, expected type [LbefreezeBalanceContract], real type[" + any
              .getClass() + "]");
    }
    final LbefreezeBalanceContract unfreezeBalanceContract;
    try {
      unfreezeBalanceContract = this.any.unpack(LbefreezeBalanceContract.class);
    } catch (InvalidProtocolBufferException e) {
      logger.debug(e.getMessage(), e);
    ...
    if (!ArrayUtils.isEmpty(receiverAddress) && dynamicStore.supportDR()) {
      ...
      switch (unfreezeBalanceContract.getResource()) {
        case BANDWIDTH:
          ...
          long allowedLbefreezeCount = accountCapsule.getFrozenList().stream()
  ...
  public ByteString getOwnerAddress() throws InvalidProtocolBufferException {
    return any.unpack(LbefreezeBalanceContract.class).getOwnerAddress();
  }
