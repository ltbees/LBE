 ...
 */
package org.un.core.vm.program.invoke;
...
import static org.un.common.utils.WalletUtil.generateContractAddress;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.LbeType trxType,
    ...
    if (trxType == LBE_CONTRACT_CREATION_TYPE) {
    ...
    } else if (trxType == LBE_CONTRACT_CALL_TYPE) {
