package org.un.core.vm;

import static org.un.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.un.common.crypto.Hash.sha3;
import static org.un.core.db.TransactionTrace.convertToLbeAddress;
import static org.un.core.vm.OpCode.CALL;
import static org.un.core.vm.OpCode.CALLTOKEN;
import static org.un.core.vm.OpCode.CALLTOKENID;
import static org.un.core.vm.OpCode.CALLTOKENVALUE;
import static org.un.core.vm.OpCode.CREATE2;
import static org.un.core.vm.OpCode.EXTCODEHASH;
import static org.un.core.vm.OpCode.ISCONTRACT;
import static org.un.core.vm.OpCode.PUSH1;
import static org.un.core.vm.OpCode.REVERT;
import static org.un.core.vm.OpCode.SAR;
import static org.un.core.vm.OpCode.SHL;
import static org.un.core.vm.OpCode.SHR;
import static org.un.core.vm.OpCode.TOKENBALANCE;
...
public class VM {
      ...
      switch (op) {
        ...
        case SSTORE:
          ...
          if (oldValue == null && !newValue.isZero()) {
            ...
            program.futureRefundEnergy(energyCosts.getREFLBED_SSTORE());
  ...
  public void play(Program program) {
    try {
      ...
      if (StringUtils.isEmpty(e.getMessage())) {
        logger.warn("Lbeknown Exception occurred, tx id: {}",
            Hex.toHexString(program.getRootTransactionId()), e);
        program.setRuntimeFailure(new RuntimeException("Lbeknown Exception"));
      } else {
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertToLbeAddress(address.getLast20Bytes()))
        == null;
  }
}
