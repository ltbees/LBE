...
import static org.un.common.runtime.vm.DataWord.WORD_SIZE;
import static org.un.common.utils.BIUtil.addSafely;
import static org.un.common.utils.BIUtil.isLessThan;
import static org.un.common.utils.BIUtil.isZero;
import static org.un.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.un.common.utils.ByteUtil.bytesToBigInteger;
import static org.un.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.un.common.utils.ByteUtil.parseBytes;
import static org.un.common.utils.ByteUtil.parseWord;
...
import org.un.common.crypto.SignatureInterface;
import org.un.common.crypto.zksnark.BN128;
import org.un.common.crypto.zksnark.BN128Fp;
import org.un.common.crypto.zksnark.BN128G1;
import org.un.common.crypto.zksnark.BN128G2;
import org.un.common.crypto.zksnark.Fp;
import org.un.common.crypto.zksnark.PairingCheck;
  ...
  public static class ValidateMultiSign extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] rawData) {
      ...
      byte[] combine = ByteUtil
          .merge(convertToLbeAddress(addr), ByteArray.fromInt(permissionId), data);
      ...
      AccountCapsule account = this.getDeposit().getAccount(convertToLbeAddress(addr));
      if (account != null) {
        try {
    ...
    private Pair<Boolean, byte[]> doExecute(byte[] data)
      ...
      if (isConstantCall()) {
        ...
        boolean withNoTimeout = countDownLatch
            .await(getCPUTimeLeftInNanoSecond(), TimeLbeit.NANOSECONDS);
