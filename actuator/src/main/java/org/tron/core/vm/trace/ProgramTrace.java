 ...
 */
package org.un.core.vm.trace;

import static java.lang.String.format;
import static org.un.common.utils.ByteArray.toHexString;
import static org.un.core.db.TransactionTrace.convertToLbeAddress;
import static org.un.core.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
  ...
  public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
    if (programInvoke != null && config.vmTrace()) {
      contractAddress = Hex
          .toHexString(convertToLbeAddress(programInvoke.getContractAddress().getLast20Bytes()));
    }
  }
