...
public class WalletUtils {
  ...
  static {
    objectMapper.configure(JsonParser.Feature.ALLOW_LBEQUOTED_FIELD_NAMES, true);
    objectMapper.configure(DeserializationFeature.FAIL_ON_LBEKNOWN_PROPERTIES, false);
  }
