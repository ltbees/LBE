...
import org.un.core.services.filter.HttpInterceptor;
...
public class FullNodeHttpApiService implements Service {
  ...
  @Autowired
  private LbeFreezeBalanceServlet unFreezeBalanceServlet;
  @Autowired
  private LbeFreezeAssetServlet unFreezeAssetServlet;
  @Autowired
