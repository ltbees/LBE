...
import org.un.api.GrpcAPI.EasyTransferAssetByPrivateMessage;
import org.un.api.GrpcAPI.EasyTransferAssetMessage;
import org.un.api.GrpcAPI.EasyTransferByPrivateMessage;
import org.un.api.GrpcAPI.EasyTransferMessage;
...
import org.un.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.un.api.GrpcAPI.TransactionList;
import org.un.api.GrpcAPI.TransactionListExtention;
import org.un.api.GrpcAPI.TransactionSignWeight;
import org.un.api.GrpcAPI.ViewingKeyMessage;
import org.un.api.GrpcAPI.WitnessList;
import org.un.api.MonitorGrpc;
import org.un.api.WalletExtensionGrpc;
import org.un.api.WalletGrpc.WalletImplBase;
...
import org.un.core.metrics.MetricsApiService;
...
import org.un.protos.Protocol.NodeInfo;
...
import org.un.protos.Protocol.TransactionSign;
import org.un.protos.contract.AccountContract.AccountCreateContract;
import org.un.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.un.protos.contract.AccountContract.AccountUpdateContract;
...
import org.un.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
...
import org.un.protos.contract.BalanceContract.LbefreezeBalanceContract;
import org.un.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.un.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.un.protos.contract.ExchangeContract.ExchangeInjectContract;
...
import org.un.protos.contract.ProposalContract.ProposalCreateContract;
...
import org.un.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
import org.un.protos.contract.SmartContractOuterClass.UpdateSettingContract;
import org.un.protos.contract.StorageContract.UpdateBrokerageContract;
...
public class RpcApiService implements Service {
   ...
   * ...
   */
  public void blockLbetilShutdown() {
    if (apiServer != null) {
      try {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.un.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.un.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getAssetIssueByName(BytesMessage request,
      ...
      if (assetName != null) {
        ...
        } catch (NonLbeiqueObjectException e) {
          responseObserver.onNext(null);
          logger.error("Solidity NonLbeiqueObjectException: {}", e.getMessage());
        }
      } else {
        responseObserver.onNext(null);
      }
  ...
  public class WalletApi extends WalletImplBase {
    ...
    @Override
    public void unfreezeAsset(LbefreezeAssetContract request,
        StreamObserver<Transaction> responseObserver) {
      try {
        responseObserver.onNext(
            createTransactionCapsule(request, ContractType.LbefreezeAssetContract).getInstance());
      } catch (ContractValidateException e) {
        responseObserver.onNext(null);
        logger.debug(CONTRACT_VALIDATE_EXCEPTION, e.getMessage());
      }
    ...
    @Override
    public void unfreezeAsset2(LbefreezeAssetContract request,
        StreamObserver<TransactionExtention> responseObserver) {
      createTransactionExtention(request, ContractType.LbefreezeAssetContract, responseObserver);
    }
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getLbePower() < votesCount,
          "un power[" + account.getLbePower() + "] <  VotesCount[" + votesCount + "]");
    ...
    @Override
    public void unfreezeBalance(LbefreezeBalanceContract request,
        StreamObserver<Transaction> responseObserver) {
      try {
        responseObserver.onNext(
            createTransactionCapsule(request, ContractType.LbefreezeBalanceContract)
                .getInstance());
      } catch (ContractValidateException e) {
        responseObserver
            .onNext(null);
    ...
    @Override
    public void unfreezeBalance2(LbefreezeBalanceContract request,
        StreamObserver<TransactionExtention> responseObserver) {
      createTransactionExtention(request, ContractType.LbefreezeBalanceContract, responseObserver);
    }
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.un.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void getAssetIssueByName(BytesMessage request,
      ...
      if (assetName != null) {
        try {
          ...
          responseObserver.onNext(null);
          logger.debug("FullNode NonLbeiqueObjectException: {}", e.getMessage());
        }
      } else {
        responseObserver.onNext(null);
      }
