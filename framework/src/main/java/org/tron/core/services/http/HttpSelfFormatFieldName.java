...
public class HttpSelfFormatFieldName {
  ...
  static {
    ...
    //LbefreezeBalanceContract
    AddressFieldNameMap.put("protocol.LbefreezeBalanceContract.owner_address", 1);
    AddressFieldNameMap.put("protocol.LbefreezeBalanceContract.receiver_address", 1);
    //LbefreezeAssetContract
    AddressFieldNameMap.put("protocol.LbefreezeAssetContract.owner_address", 1);
