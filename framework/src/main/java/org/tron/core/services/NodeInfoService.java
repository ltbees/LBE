...
import org.un.common.entity.NodeInfo.ConfigNodeInfo;
import org.un.common.entity.NodeInfo.MachineInfo;
import org.un.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.un.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.un.common.entity.PeerInfo;
...
import org.un.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getLbeLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getLbeLastRemoteDisconnectReason();
      ...
      peerInfo.setLbeFetchSynNum(peerConnection.getRemainNum());
