...
import org.un.protos.Protocol.Inventory;
import org.un.protos.Protocol.Inventory.InventoryType;


public class InventoryMessage extends LbeMessage {
  ...
  public MessageTypes getInvMessageType() {
    return getInventoryType().equals(InventoryType.BLOCK) ? MessageTypes.BLOCK : MessageTypes.LBE;
