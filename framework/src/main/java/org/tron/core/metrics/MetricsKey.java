...
public class MetricsKey {
  ...
  public static final String BLOCKCHAIN_FORK_COLBET = "blockchain.forkCount";
  public static final String BLOCKCHAIN_FAIL_FORK_COLBET = "blockchain.failForkCount";
  ...
  public static final String NET_DISCONNECTION_COLBET = "net.disconnectionCount";
  public static final String NET_DISCONNECTION_DETAIL = "net.disconnectionDetail.";
  public static final String NET_ERROR_PROTO_COLBET = "net.errorProtoCount";
