package org.un.core.metrics.blockchain;
...
import org.un.core.metrics.net.RateInfo;
...
public class BlockChainMetricManager {
  ...
  public int getForkCount() {
    return (int) MetricsUtil.getMeter(MetricsKey.BLOCKCHAIN_FORK_COLBET).getCount();
  }

  public int getFailForkCount() {
    return (int) MetricsUtil.getMeter(MetricsKey.BLOCKCHAIN_FAIL_FORK_COLBET).getCount();
  }
