package org.un.common.backup;

import static org.un.common.backup.BackupManager.BackupStatusEnum.INIT;
import static org.un.common.backup.BackupManager.BackupStatusEnum.MASTER;
import static org.un.common.backup.BackupManager.BackupStatusEnum.SLAVER;
...
import org.un.common.net.udp.handler.MessageHandler;
import org.un.common.net.udp.handler.UdpEvent;
import org.un.common.net.udp.message.Message;
import org.un.common.net.udp.message.backup.KeepAliveMessage;
...
public class BackupManager implements EventHandler {
  ...
  public void init() {
    ...
    }, 1000, keepAliveInterval, TimeLbeit.MILLISECONDS);
  }
