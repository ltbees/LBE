...
import org.un.core.vm.repository.Key;
import org.un.core.vm.repository.Type;
import org.un.core.vm.repository.Value;
...
public class DepositImpl implements Deposit {
  ...
  public synchronized void putStorageValue(byte[] address, DataWord key, DataWord value) {
    address = convertToLbeAddress(address);
