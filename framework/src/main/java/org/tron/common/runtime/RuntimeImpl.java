...
import org.un.core.actuator.Actuator2;
...
import org.un.core.vm.program.Program.BadJumpDestinationException;
import org.un.core.vm.program.Program.IllegalOperationException;
...
import org.un.core.vm.program.Program.OutOfMemoryException;
import org.un.core.vm.program.Program.OutOfTimeException;
import org.un.core.vm.program.Program.PrecompiledContractException;
import org.un.core.vm.program.Program.StackTooLargeException;
import org.un.core.vm.program.Program.StackTooSmallException;
...
public class RuntimeImpl implements Runtime {
  ...
  public void execute(TransactionContext context)
    ...
    ContractType contractType = context.getLbeCap().getInstance().getRawData().getContract(0)
        .getType();
    switch (contractType.getNumber()) {
      ...
      case ContractType.CreateSmartContract_VALUE:
        ...
        break;
      default:
        actuatorList = ActuatorCreator.getINSTANCE().createActuator(context.getLbeCap());
    }
    if (actuator2 != null) {
  ...
  private void setResultCode(ProgramResult result) {
    ...
    result.setResultCode(contractResult.LBEKNOWN);
  }
