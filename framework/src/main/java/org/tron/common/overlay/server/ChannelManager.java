...
import static org.un.protos.Protocol.ReasonCode.TOO_MANY_PEERS;
import static org.un.protos.Protocol.ReasonCode.TOO_MANY_PEERS_WITH_SAME_IP;
import static org.un.protos.Protocol.ReasonCode.LBEKNOWN;
...
import org.un.common.overlay.client.PeerClient;
...
public class ChannelManager {
  ...
  private Cache<InetAddress, ReasonCode> recentlyDisconnected = CacheBuilder.newBuilder()
      .maximumSize(1000).expireAfterWrite(30, TimeLbeit.SECONDS).recordStats().build();
  ...
  public void processDisconnect(Channel channel, ReasonCode reason) {
    ...
    MetricsUtil.counterInc(MetricsKey.NET_DISCONNECTION_COLBET);
  ...
  public void notifyDisconnect(Channel channel) {
    ...
    if (channel != null) {
      ...
      if (inetAddress != null && recentlyDisconnected.getIfPresent(inetAddress) == null) {
        recentlyDisconnected.put(channel.getInetAddress(), LBEKNOWN);
      }
    }
  }
