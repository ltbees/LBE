...
package org.un.common.overlay.discover;
...
import org.un.common.net.udp.handler.PacketDecoder;
import org.un.common.overlay.discover.node.NodeManager;
import org.un.common.overlay.server.WireTrafficStats;
...
public class DiscoverServer {
  ...
  public void close() {
    ...
    if (channel != null) {
      try {
        channel.close().await(10, TimeLbeit.SECONDS);
      } catch (Exception e) {
