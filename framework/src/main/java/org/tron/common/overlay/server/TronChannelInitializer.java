...
@Component
@Scope("prototype")
public class LbeChannelInitializer extends ChannelInitializer<NioSocketChannel> {
  ...
  public LbeChannelInitializer(String remoteId) {
  ...
  public void initChannel(NioSocketChannel ch) throws Exception {
    try {
      ...
      logger.error("Lbeexpected error: ", e);
    }
  }
