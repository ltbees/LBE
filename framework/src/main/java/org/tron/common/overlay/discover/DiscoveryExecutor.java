...
import org.un.common.overlay.discover.table.KademliaOptions;
...
public class DiscoveryExecutor {
  ...
  public void start() {
    discoverer.scheduleWithFixedDelay(
        ...
        1, KademliaOptions.DISCOVER_CYCLE, TimeLbeit.SECONDS);

    refresher.scheduleWithFixedDelay(
        new RefreshTask(nodeManager),
        1, KademliaOptions.BUCKET_REFRESH, TimeLbeit.MILLISECONDS);
  }
