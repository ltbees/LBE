...
public class PeerServer {
  ...
  public void start(int port) {
    ...
    EventLoopGroup unsGroup = new NioEventLoopGroup(1);
    EventLoopGroup workerGroup = new NioEventLoopGroup(parameter.getTcpNettyWorkThreadNum());
    LbeChannelInitializer unChannelInitializer = ctx.getBean(LbeChannelInitializer.class, "");

    try {
      ServerBootstrap b = new ServerBootstrap();

      b.group(unsGroup, workerGroup);
      ...
      b.childHandler(unChannelInitializer);
