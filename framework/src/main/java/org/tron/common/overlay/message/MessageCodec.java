...
import org.un.core.net.message.PbftMessageFactory;
import org.un.core.net.message.LbeMessageFactory;
...
public class MessageCodec extends ByteToMessageDecoder {
  ...
  private LbeMessageFactory unMessageFactory = new LbeMessageFactory();
  ...
  private Message createMessage(byte[] encoded) throws Exception {
    ...
    if (MessageTypes.inLbeRange(type)) {
      return unMessageFactory.create(encoded);
    }
