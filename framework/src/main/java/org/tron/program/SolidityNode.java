...
import org.un.common.overlay.client.DatabaseGrpcClient;
...
import org.un.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new LbeApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    LbeNetService unNetService = context.getBean(LbeNetService.class);
    unNetService.stop();
