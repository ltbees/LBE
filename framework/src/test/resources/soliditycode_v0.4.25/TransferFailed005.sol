contract EnergyOfTransferFailedTest {
    ...
    function testCallLbeInsufficientBalance(uint256 i,address caller) public returns (bool){
    ...
    function testSendLbeNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
        nonexistentTarget.send(i);
    }

    function testTransferLbeNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
    ...
    function testCallLbeNonexistentTarget(uint256 i,address  nonexistentTarget) payable public {
        require(address(this).balance >= i);
