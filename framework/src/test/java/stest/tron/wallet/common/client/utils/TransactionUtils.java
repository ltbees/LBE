...
import org.un.protos.contract.SmartContractOuterClass;
import org.un.protos.contract.VoteAssetContractOuterClass;
...
public class TransactionUtils {
  ...
  /*  public static Transaction setDelaySeconds(Transaction transaction, long delaySeconds) {
    DeferredStage deferredStage = transaction.getRawData().toBuilder()
        ...
        .setStage(LBEEXECUTEDDEFERREDTRANSACTION).build();
