...
public class FreezeBalance2Test {
  ...
  public void testFreezeBalance2() {
    ...
    //Freeze failed when freeze amount less than 1Lbe
    ret1 = freezeBalance2(fromAddress, 999999L, 3L, testKey002);
    Assert.assertEquals(ret1.getCode(), GrpcAPI.Return.response_code.CONTRACT_VALIDATE_ERROR);
    Assert.assertEquals(ret1.getMessage().toStringUtf8(),
        "contract validate error : frozenBalance must be more than 1LBE");
    ...
    //Lbefreeze balance failed when 3 days hasn't come.
  ...
  @Test(enabled = true)
  public void testLbeFreezeBalance2() {
    //Lbefreeze failed when there is no freeze balance.
  ...
  public void shutdown() throws InterruptedException {
    ...
    if (searchChannelFull != null) {
      searchChannelFull.shutdown().awaitTermination(5, TimeLbeit.SECONDS);
    }
  }
