...
public class UpdateAsset2Test {
  ...
  public boolean unFreezeAsset(byte[] addRess, String priKey) {
    ...
    AssetIssueContractOuterClass.LbefreezeAssetContract.Builder builder =
        AssetIssueContractOuterClass.LbefreezeAssetContract
            .newBuilder();
    ByteString byteAddreess = ByteString.copyFrom(address);

    builder.setOwnerAddress(byteAddreess);

    AssetIssueContractOuterClass.LbefreezeAssetContract contract = builder.build();
