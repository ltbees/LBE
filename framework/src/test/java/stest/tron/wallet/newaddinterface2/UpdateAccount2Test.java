package stest.un.wallet.newaddinterface2;
...
//import stest.un.wallet.common.client.AccountComparator;
...
public class UpdateAccount2Test {
  ...
  @Test(enabled = true)
  public void testNoBalanceTransferLbe2() {
  ...
  @Test(enabled = true)
  public void testNoFreezeBalanceToLbefreezeBalance2() {
    //Lbefreeze account failed when no freeze balance
  ...
  public boolean unFreezeBalance(byte[] address, String priKey) {
    ...
    final ECKey ecKey = temKey;
    BalanceContract.LbefreezeBalanceContract.Builder builder =
        BalanceContract.LbefreezeBalanceContract
            .newBuilder();
    ByteString byteAddreess = ByteString.copyFrom(address);

    builder.setOwnerAddress(byteAddreess);

    BalanceContract.LbefreezeBalanceContract contract = builder.build();
