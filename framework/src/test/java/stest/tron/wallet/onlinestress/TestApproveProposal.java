...
import org.un.protos.Protocol.ChainParameters;
...
public class TestApproveProposal {
  ...
  public void testGetChainParameters() {
    ...
    defaultCommitteeMap.put("ACCOLBET_UPGRADE_COST", 9999000000L);
    defaultCommitteeMap.put("CREATE_ACCOLBET_FEE", 100000L);
    ...
    defaultCommitteeMap.put("CREATE_NEW_ACCOLBET_FEE_IN_SYSTEM_CONTRACT", 0L);
    defaultCommitteeMap.put("CREATE_NEW_ACCOLBET_BANDWIDTH_RATE", 1L);
