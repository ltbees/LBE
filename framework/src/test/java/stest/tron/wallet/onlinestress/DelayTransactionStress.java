...
//import org.un.protos.Protocol.DeferredTransaction;
...
public class DelayTransactionStress {
  ...
  public void test2getDeferredTransactionByid() {
   ...
   // logger.info("delaySeconds is " + transaction.getDelaySeconds());
    ...
    //logger.info("DelayLbetil " + transaction.getDelayLbetil());
    Assert.assertTrue(transaction.getDelayLbetil() > System.currentTimeMillis());
    ...
    //Assert.assertTrue(transaction.getDelayLbetil() + 60000 == transaction.getExpiration());
