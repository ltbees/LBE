package stest.un.wallet.dailybuild.tvmnewcommand.transferfailed;

import static org.un.protos.Protocol.TransactionInfo.code.FAILED;
...
public class TransferFailed001 {
  ...
  public void test001TransferLbeInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferLbeInsufficientBalance(uint256)", num, false,
  ...
  public void test003TransferLbeNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferLbeNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  public void test004TransferLbeSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferLbeSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer trx failed: Cannot transfer LBE to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  public void test005TransferLbeNonexistentTarget() {
  ...
  public void test006TransferLbeSelf() {
  ...
  @Test(enabled = true, description = "transferLbe to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferLberevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
