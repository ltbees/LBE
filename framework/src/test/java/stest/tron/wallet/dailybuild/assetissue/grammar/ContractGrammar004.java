package stest.un.wallet.dailybuild.assetissue.grammar;

import static org.un.protos.Protocol.Transaction.Result.contractResult.BAD_JUMP_DESTINATION_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.ILLEGAL_OPERATION_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.OUT_OF_MEMORY_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.OUT_OF_TIME_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.REVERT_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.un.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
...
public class ContractGrammar004 {
  ...
  public void test4Grammar004() {
    ...
    String filePath = "src/test/resources/soliditycode/contractLbeknownException.sol";
  ...
  public void test8Grammar008() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testTransferLbeNonexistentTarget(uint256,address)", num,
  ...
  public void shutdown() throws InterruptedException {
    ...
    if (channelFull1 != null) {
      channelFull1.shutdown().awaitTermination(5, TimeLbeit.SECONDS);
    }
  }
