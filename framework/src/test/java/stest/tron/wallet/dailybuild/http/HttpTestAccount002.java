package stest.un.wallet.dailybuild.http;
...
import stest.un.wallet.common.client.utils.HttpMethed;
...
public class HttpTestAccount002 {
   ...
   * constructor.
   */
  @Test(enabled = true, description = "LbeFreezeBalance for bandwidth by http")
  public void test002LbeFreezebalanceForBandwidth() {
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);

    //LbeFreeze balance for bandwidth
   ...
   * constructor.
   */
  @Test(enabled = true, description = "LbeFreezeBalance for energy by http")
  public void test004LbeFreezebalanceForEnergy() {

    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
    HttpMethed.waitToProduceOneBlock(httpnode);
    //LbeFreeze balance for energy
   ...
   * constructor.
   */
  @Test(enabled = true, description = "LbeFreezeBalance with bandwidth for others by http")
  public void test012LbeFreezebalanceOfBandwidthForOthers() {
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);

    //LbeFreeze balance with bandwidth for others
    response = HttpMethed
   ...
   * constructor.
   */
  @Test(enabled = true, description = "LbeFreezeBalance with energy for others by http")
  public void test014LbeFreezebalanceOfEnergyForOthers() {
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);

    //LbeFreeze balance with energy for others
    response = HttpMethed
