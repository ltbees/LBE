package stest.un.wallet.dailybuild.tvmnewcommand.create2;
...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long afterLbefreezeBalance = PublicMethed.queryAccount(resourceOnwerAddress, blockingStubFull)
        .getBalance();
    Assert.assertTrue(afterLbefreezeBalance == beforeExcAccountBalance + 1000000L * 2);
