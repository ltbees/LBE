...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendLbeInsufficientBalance(uint256)", num, false, 0,
  ...
  public void test3SendLbeNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendLbeNonexistentTarget(uint256,address)", num,
  ...
  public void test4SendLbeSelf() {
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendLbeSelf(uint256)", num, false, 0, maxFeeLimit,
  ...
  public void test5SendLbeNonexistentTarget() {
    Account info;
  ...
  public void test7SendLbeNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendLbeRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
