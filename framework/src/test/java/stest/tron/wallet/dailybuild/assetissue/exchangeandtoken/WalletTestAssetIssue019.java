package stest.un.wallet.dailybuild.assetissue.exchangeandtoken;
...
public class WalletTestAssetIssue019 {
  ...
  @Test(enabled = true)
  public void testCanNotCreateTokenNameByLbe() {
    //get account
    ...
    Assert.assertFalse(PublicMethed.createAssetIssue(asset019Address,
        "LBE", totalSupply, 1, 1, start, end, 1, description, url,
        2000L, 2000L, 1L, 1L, asset019Key, blockingStubFull));
