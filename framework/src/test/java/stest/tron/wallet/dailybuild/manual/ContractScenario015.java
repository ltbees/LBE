...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "LBE TRC20 transfer token")
  public void trc20Lbe() {
    ...
    String contractName = "LBE TRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_TRC20_LBE");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_TRC20_LBE");
