package stest.un.wallet.dailybuild.exceptionfee;
...
public class AssertException {
  ...
  public void test6LbeinitializedContract() {
    String filePath =
        "src/test/resources/soliditycode/assertExceptiontest6LbeinitializedContract.sol";
