...
import static org.un.protos.Protocol.Transaction.Result.contractResult.SUCCESS_VALUE;
...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertEquals("contract validate error : Cannot transfer LBE to a smartContract.",
