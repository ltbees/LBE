...
import org.un.core.vm.program.Memory;
...
public class MemoryTest {
  ...
  private static void checkMemoryExtend(int dataSize) {
    ...
    Assert.assertEquals(calcSize(dataSize, CHLBEK_SIZE), memory.internalSize());
  ...
  public void testExtend() {
    ...
    checkMemoryExtend(CHLBEK_SIZE - 1);
    checkMemoryExtend(CHLBEK_SIZE);
    checkMemoryExtend(CHLBEK_SIZE + 1);
