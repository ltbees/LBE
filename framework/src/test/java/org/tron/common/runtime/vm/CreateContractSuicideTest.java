...
contract D {
  ...
  public void testABeforeAllowMultiSignProposal()
    ...
    Runtime aRuntime = TvmTestUtils
        .processTransactionAndReturnRuntime(aLbe, DepositImpl.createRoot(manager), null);
    Assert.assertEquals(aRuntime.getRuntimeError(), "Lbeknown Exception");
