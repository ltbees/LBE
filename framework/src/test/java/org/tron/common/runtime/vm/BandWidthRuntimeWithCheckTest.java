...
public class BandWidthRuntimeWithCheckTest {
  ...
  public void testSuccess() {
    try {
      ...
      Assert.assertEquals(624668 * Constant.SLBE_PER_ENERGY,
          balance + energy * Constant.SLBE_PER_ENERGY);
    } catch (LbeException e) {
  ...
  private byte[] createContract()
    ...
    Assert
        .assertEquals(88529 * Constant.SLBE_PER_ENERGY,
            balance + energy * Constant.SLBE_PER_ENERGY);
