...
import org.un.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.un.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.un.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.un.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.un.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.un.core.capsule.ReceiveDescriptionCapsule;
import org.un.core.capsule.SpendDescriptionCapsule;
...
import org.un.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.un.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
import org.un.core.zen.address.DiversifierT;
import org.un.core.zen.address.ExpandedSpendingKey;
import org.un.core.zen.address.FullViewingKey;
...
import org.un.core.zen.note.Note.NotePlaintextEncryptionResult;
import org.un.core.zen.note.NoteEncryption;
...
import org.un.protos.contract.ShieldContract.SpendDescription;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static final long FROM_AMOLBET = 110_000_000;
  private static final long tokenId = 1;
  private static final String ASSET_NAME = "trx";
  private static final int LBE_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "LBE";
  ...
  private static byte[] randomUint256() {
    return org.un.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.un.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.un.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.un.keystore.Wallet.generateRandomBytes(580);
  }
  ...
  public void testTransparentInputInsufficient() throws RuntimeException, ZksnarkException {
    ...
    //generate input
    builder.setTransparentInput(ByteArray.fromHexString(FROM_ADDRESS), FROM_AMOLBET); // fail
    //builder.setTransparentInput(ByteArray.fromHexString(FROM_ADDRESS), OWNER_BALANCE); //success
    byte[] senderOvk = randomUint256();
    ...
    PaymentAddress paymentAddress = ivk.address(new DiversifierT()).get();
    builder.addOutput(senderOvk, paymentAddress,
        FROM_AMOLBET - wallet.getShieldedTransactionFee(), new byte[512]); // fail
    //builder.addOutput(senderOvk, paymentAddress,
    //        OWNER_BALANCE - wallet.getShieldedTransactionFee(), new byte[512]); //success
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.un.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testSignWithoutFromAmout()
    ...
    try {
      ...
      //test case
      hashOfTransaction = hashWithMissingColumn(transactionCapsule,
          TestSignMissingColumn.FROM_AMOLBET);
      //end of test case
  ...
  public void testSignWithoutToAmount()
    ...
    try {
      ...
      //test case
      hashOfTransaction = hashWithMissingColumn(transactionCapsule,
          TestSignMissingColumn.TO_AMOLBET);
      //end of test case
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.un.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.un.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.un.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.un.keystore.Wallet.generateRandomBytes(512);
    ...
    for (int i = 0; i < 1; i++) {
      org.un.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.un.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zun1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";
  ...
  public enum TestSignMissingColumn {
    FROM_ADDRESS, FROM_AMOLBET, SPEND_DESCRITPION,
    RECEIVE_DESCRIPTION, TO_ADDRESS, TO_AMOLBET
  }
