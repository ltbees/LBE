...
import static org.un.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.un.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.un.common.zksnark.LibrustzcashParam.ComputeCmParams;
import org.un.common.zksnark.LibrustzcashParam.FinalCheckParams;
...
import org.un.common.zksnark.MerklePath;
import org.un.common.zksnark.ZksnarkClient;
...
import org.un.core.actuator.ShieldedTransferActuator;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setLbeNum(LBE_NUM).setNum(NUM)
