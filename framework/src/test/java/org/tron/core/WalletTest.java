...
import org.un.protos.Protocol.BlockHeader.raw;
...
public class WalletTest {
  ...
  public static final String ACCOLBET_ADDRESS_ONE = "121212a9cf";
  public static final String ACCOLBET_ADDRESS_TWO = "232323a9cf";
  public static final String ACCOLBET_ADDRESS_THREE = "343434a9cf";
  public static final String ACCOLBET_ADDRESS_FOUR = "454545a9cf";
  public static final String ACCOLBET_ADDRESS_FIVE = "565656a9cf";
  public static final String ACCOLBET_ADDRESS_SIX = "12344349cf";
  ...
  private static void initBlock() {
    ...
    block1 = getBuildBlock(BLOCK_TIMESTAMP_ONE, BLOCK_NUM_ONE, BLOCK_WITNESS_ONE,
        ACCOLBET_ADDRESS_ONE, transaction1, transaction2);
    ...
    block2 = getBuildBlock(BLOCK_TIMESTAMP_TWO, BLOCK_NUM_TWO, BLOCK_WITNESS_TWO,
        ACCOLBET_ADDRESS_TWO, transaction2, transaction3);
    ...
    block3 = getBuildBlock(BLOCK_TIMESTAMP_THREE, BLOCK_NUM_THREE, BLOCK_WITNESS_THREE,
        ACCOLBET_ADDRESS_THREE, transaction2, transaction4);
    ...
    block4 = getBuildBlock(BLOCK_TIMESTAMP_FOUR, BLOCK_NUM_FOUR, BLOCK_WITNESS_FOUR,
        ACCOLBET_ADDRESS_FOUR, transaction4, transaction5);
    ...
    block5 = getBuildBlock(BLOCK_TIMESTAMP_FIVE, BLOCK_NUM_FIVE, BLOCK_WITNESS_FIVE,
        ACCOLBET_ADDRESS_FIVE, transaction5, transaction3);
