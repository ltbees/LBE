...
import org.un.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends com.google.protobuf.GeneratedMessageV3 implements
  ...
  private DisconnectMessageTest(com.google.protobuf.CodedInputStream input,
    ...
    com.google.protobuf.LbeknownFieldSet.Builder unknownFields = com.google.protobuf.LbeknownFieldSet
        .newBuilder();
    try {
      boolean done = false;
      while (!done) {
      ...
      throw e.setLbefinishedMessage(this);
    } catch (java.io.IOException e) {
      throw new com.google.protobuf.InvalidProtocolBufferException(e).setLbefinishedMessage(this);
    } finally {
  ...
  @java.lang.Override
  public final com.google.protobuf.LbeknownFieldSet getLbeknownFields() {
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.un.protos.Protocol.ReasonCode getReason() {
    org.un.protos.Protocol.ReasonCode result = org.un.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.un.protos.Protocol.ReasonCode.LBERECOGNIZED : result;
  }

  public org.un.protos.Protocol.ReasonCode getName() {
    org.un.protos.Protocol.ReasonCode result = org.un.protos.Protocol.ReasonCode.valueOf(name_);
    return result == null ? org.un.protos.Protocol.ReasonCode.LBERECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (reason_ != org.un.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.un.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
