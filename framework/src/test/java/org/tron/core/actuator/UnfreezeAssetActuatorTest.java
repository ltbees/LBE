...
@Slf4j
public class LbefreezeAssetActuatorTest {
  ...
  private Any getContract(String ownerAddress) {
    return Any.pack(
        LbefreezeAssetContract.newBuilder()
  ...
  /**
   * SameTokenName close, Lbefreeze assert success.
   */
  @Test
  public void SameTokenNameCloseLbefreezeAsset() {
    ...
    LbefreezeAssetActuator actuator = new LbefreezeAssetActuator();
  ...
  /**
   * SameTokenName active, Lbefreeze assert success.
   */
  @Test
  public void SameTokenNameActiveLbefreezeAsset() {
  ...
  /**
   * when init data, SameTokenName is close, then open SameTokenName, Lbefreeze assert success.
   */
  @Test
  public void SameTokenNameActiveInitAndAcitveLbefreezeAsset() {
    createAssertBeforSameTokenNameActive();
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(1);
    long tokenId = dbManager.getDynamicPropertiesStore().getTokenIdNum();
    long now = System.currentTimeMillis();
  ...
  public void invalidOwnerAccount() {
    ...
    LbefreezeAssetActuator actuator = new LbefreezeAssetActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContract(OWNER_ACCOLBET_INVALID));
  ...
  public void commonErrorCheck() {
    ...
    actuatorTest.setInvalidContractTypeMsg("contract type error",
        "contract type error, expected type [LbefreezeAssetContract], real type[");
