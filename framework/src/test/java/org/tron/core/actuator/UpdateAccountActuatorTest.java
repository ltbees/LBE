...
public class UpdateAccountActuatorTest {
  ...
  private static final String ACCOLBET_NAME = "ownerTest";
  private static final String ACCOLBET_NAME_1 = "ownerTest1";
  ...
  public void createCapsule() {
    ...
    dbManager.getAccountIndexStore().delete(ACCOLBET_NAME.getBytes());
    dbManager.getAccountIndexStore().delete(ACCOLBET_NAME_1.getBytes());
  ...
  public void rightUpdateAccount() {
    UpdateAccount(ACCOLBET_NAME, OWNER_ADDRESS);
  }
  ...
  public void invalidAddress() {
    ...
    UpdateAccountActuator actuator = new UpdateAccountActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContract(ACCOLBET_NAME, OWNER_ADDRESS_INVALID));
  ...
  public void noExitAccount() {
    ...
    UpdateAccountActuator actuator = new UpdateAccountActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContract(ACCOLBET_NAME, OWNER_ADDRESS_1));
  ...
  public void twiceUpdateAccountFail() {
    ...
    try {
      ...
      Assert.assertEquals(ACCOLBET_NAME, accountCapsule.getAccountName().toStringUtf8());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  }
  ...
  public void twiceUpdateAccountSuccess() {
    ...
    // than 1 time
    UpdateAccount(ACCOLBET_NAME_1, OWNER_ADDRESS);  // second update
  ...
  public void updateSameNameSuccess() {
    ...
    UpdateAccount(ACCOLBET_NAME, OWNER_ADDRESS);   // first update account

    dbManager.getDynamicPropertiesStore().saveAllowUpdateAccountName(1);   // allow update more
    // than one time
    UpdateAccount(ACCOLBET_NAME, OWNER_ADDRESS);   // second update with same account Name
  ...
  public void nullTransationResult() {
    UpdateAccountActuator actuator = new UpdateAccountActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContract(ACCOLBET_NAME, OWNER_ADDRESS));
