...
public class SetAccountIdActuatorTest {
  ...
  public void createCapsule() {
    ...
    dbManager.getAccountIdIndexStore().delete(ACCOLBET_NAME.getBytes());
    dbManager.getAccountIdIndexStore().delete(ACCOLBET_NAME_1.getBytes());
  }
  ...
  public void rightSetAccountId() {
    ...
    try {
      ...
      Assert.assertEquals(ACCOLBET_NAME, accountCapsule.getAccountId().toStringUtf8());
  ...
  public void commonErrorCheck() {
    ...
    actuatorTest.setContract(getContract(ACCOLBET_NAME, OWNER_ADDRESS));
