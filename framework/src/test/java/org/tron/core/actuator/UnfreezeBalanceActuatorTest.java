...
import org.un.protos.contract.Common.ResourceCode;

@Slf4j
public class LbefreezeBalanceActuatorTest {

  private static final String dbPath = "output_unfreeze_balance_test";
  private static final String OWNER_ADDRESS;
  private static final String RECEIVER_ADDRESS;
  private static final String OWNER_ADDRESS_INVALID = "aaaa";
  private static final String OWNER_ACCOLBET_INVALID;
  ...
  private Any getContractForBandwidth(String ownerAddress) {
    return Any.pack(LbefreezeBalanceContract.newBuilder()
  ...
  @Test
  public void testLbefreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getLbePower(), frozenBalance);

    dbManager.getAccountStore().put(accountCapsule.createDbKey(), accountCapsule);
    LbefreezeBalanceActuator actuator = new LbefreezeBalanceActuator();
    ...
    try {
      ...
      Assert.assertEquals(owner.getLbePower(), 0L);
  ...
  @Test
  public void testLbefreezeBalanceForEnergy() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getLbePower());
    ...
    Assert.assertEquals(0L, receiver.getLbePower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getLbePower());
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForBandwidthWithDeletedReceiver() {
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForBandwidthWithRecreatedReceiver() {
    dbManager.getDynamicPropertiesStore().saveAllowDelegateResource(1);
    dbManager.getDynamicPropertiesStore().saveAllowTvmConstantinople(1);
   ...
   */
  @Test
  public void testLbefreezeDelegatedBalanceForBandwidthSameTokenNameClose() {
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForCpu() {
    dbManager.getDynamicPropertiesStore().saveAllowDelegateResource(1);
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForCpuWithDeletedReceiver() {
    dbManager.getDynamicPropertiesStore().saveAllowDelegateResource(1);
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
  ...
  @Test
  public void testLbefreezeDelegatedBalanceForCpuWithRecreatedReceiver() {
    dbManager.getDynamicPropertiesStore().saveAllowDelegateResource(1);
    dbManager.getDynamicPropertiesStore().saveAllowTvmConstantinople(1);
  ...
  public void invalidOwnerAccount() {
    ...
    LbefreezeBalanceActuator actuator = new LbefreezeBalanceActuator();
    actuator.setChainBaseManager(dbManager.getChainBaseManager())
        .setAny(getContractForBandwidth(OWNER_ACCOLBET_INVALID));
    TransactionResultCapsule ret = new TransactionResultCapsule();
    try {
      actuator.validate();
      actuator.execute(ret);
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("Account[" + OWNER_ACCOLBET_INVALID + "] does not exist",
          e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  ...
  @Test
  public void notTimeToLbefreeze() {
    long now = System.currentTimeMillis();
    dbManager.getDynamicPropertiesStore().saveLatestBlockHeaderTimestamp(now);
  ...
  public void commonErrorCheck() {
    ...
    actuatorTest.setInvalidContractTypeMsg("contract type error",
        "contract type error, expected type [LbefreezeBalanceContract], real type[");
