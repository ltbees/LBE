...
public class TransactionUtilTest {
  ...
  @Test
  public void validAccountNameCheck() throws LbesupportedEncodingException {
  ...
  @Test
  public void validAccountIdCheck() throws LbesupportedEncodingException {
    TransactionUtil actuatorUtil = new TransactionUtil();
    String accountId = "";
  ...
  @Test
  public void validAssetNameCheck() throws LbesupportedEncodingException {
    TransactionUtil actuatorUtil = new TransactionUtil();
    String assetName = "";
  ...
  @Test
  public void validTokenAbbrNameCheck() throws LbesupportedEncodingException {
  ...
  @Test
  public void isNumberCheck() throws LbesupportedEncodingException {
    TransactionUtil actuatorUtil = new TransactionUtil();
    String number = "";
