...
public class ShieldedTransferActuatorTest {
  ...
  private static final long AMOLBET = 100000000L;
  ...
  private TransactionCapsule getPublicToShieldedTransaction() throws Exception {
    ...
    //From amount
    builder.setTransparentInput(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE), AMOLBET);
    //TO amount
    SpendingKey spendingKey = SpendingKey.random();
    FullViewingKey fullViewingKey = spendingKey.fullViewingKey();
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(DiversifierT.random()).get();
    builder.addOutput(fullViewingKey.getOvk(), paymentAddress, AMOLBET - fee, new byte[512]);
  ...
  public void publicAddressToPublicAddressAndZereValueOutputSuccess() {
    ...
    try {
      ...
      builder.setTransparentOutput(ByteArray.fromHexString(PUBLIC_ADDRESS_TWO), AMOLBET - fee);
  ...
  public void publicAddressToShieldedInsufficientBalance() {
    ...
    try {
      TransactionCapsule transactionCap = getPublicToShieldedTransaction();
      setAssertBalance(accountCapsule, AMOLBET - 1000000);

      Contract contract =
          transactionCap.getInstance().toBuilder().getRawDataBuilder().getContract(0);
      ShieldedTransferContract shieldedTransferContract = contract.getParameter()
          .unpack(ShieldedTransferContract.class);
      Assert.assertEquals(AMOLBET, shieldedTransferContract.getFromAmount());
  ...
  public void publicAddressToShieldedAddressNotConsumeBandwidth() {
    ...
    try {
      ...
      accountCapsule =
          dbManager.getAccountStore().get(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE));
      Assert.assertEquals(assertBalance - AMOLBET, getAssertBalance(accountCapsule));
  ...
  public void shieldAddressOnlyToPublicAddressFailure() {
    ...
    try {
      ...
      Note note = new Note(address, AMOLBET + fee);
  ...
  public void publicAddressToShieldedInvalidToAmount() {
    ...
    try {
      ...
      ExpandedSpendingKey expsk = sk.expandedSpendingKey();
      PaymentAddress address = sk.defaultAddress();
      Note note = new Note(address, AMOLBET);
      IncrementalMerkleVoucherContainer voucher = createSimpleMerkleVoucherContainer(note.cm());
      byte[] anchor = voucher.root().getContent().toByteArray();
      dbManager.getMerkleContainer().putMerkleTreeIntoStore(anchor,
          voucher.getVoucherCapsule().getTree());
  ...
  public void publicAddressToShieldedInvalidFromAddress() throws ZksnarkException {
    ...
    ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
    //From amount
    builder.setTransparentInput(ByteArray.fromHexString(INVAILID_ADDRESS), AMOLBET);
    //TO amount
    SpendingKey spendingKey = SpendingKey.random();
    FullViewingKey fullViewingKey = spendingKey.fullViewingKey();
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
  ...
  public void publicAddressToShieldedInvalidToAddress() {
    ...
    try {
      ...
      //TO amount
      addZeroValueOutputNote(builder);
      builder.setTransparentOutput(ByteArray.fromHexString(INVAILID_ADDRESS), AMOLBET - fee);
      TransactionCapsule transactionCap = builder.build();
  ...
  public void transferFromPublicAndShieldAddressFailure() {
    ...
    try {
      ...
      builder.setTransparentInput(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE), AMOLBET);
      //TO amount
      builder.setTransparentOutput(ByteArray.fromHexString(PUBLIC_ADDRESS_TWO), 2 * AMOLBET - fee);
      TransactionCapsule transactionCap = builder.build();
  ...
  public void publicAddressToShieldMoreThan10NoteFailure() {
    ...
    try {
      //From amount
      builder.setTransparentInput(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE), 3 * AMOLBET + fee);
      //TO amount
      for (int i = 0; i < 3; i++) {
        SpendingKey spendingKey = SpendingKey.random();
        FullViewingKey fullViewingKey = spendingKey.fullViewingKey();
        ...
        PaymentAddress paymentAddress = incomingViewingKey.address(DiversifierT.random())
            .get();
        builder.addOutput(fullViewingKey.getOvk(), paymentAddress, AMOLBET, new byte[512]);
      }
      TransactionCapsule transactionCap = builder.build();
  ...
  public void publicAddressToShieldAddressNoFromAddressFailure() throws ZksnarkException {
    ...
    ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
    //From amount
    builder.setTransparentInput(ByteArray.fromHexString(null), AMOLBET);
    //TO amount
    SpendingKey spendingKey = SpendingKey.random();
    FullViewingKey fullViewingKey = spendingKey.fullViewingKey();
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
  ...
  public void publicAddressAndShieldAddressToShieldAddressNoFromAddressFailure() {
    ...
    try {
      ...
      IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
      PaymentAddress paymentAddress = incomingViewingKey.address(DiversifierT.random()).get();
      builder.addOutput(fullViewingKey.getOvk(), paymentAddress, 2 * AMOLBET - fee, new byte[512]);
  ...
  public void publicAddressAToShieldAddressNoToAddressFailure() {
    ...
    try {
      ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
      //From amount
      builder.setTransparentInput(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE), 2 * AMOLBET + fee);
      //TO amount
      SpendingKey spendingKey = SpendingKey.random();
      FullViewingKey fullViewingKey = spendingKey.fullViewingKey();
      IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
      PaymentAddress paymentAddress = incomingViewingKey.address(DiversifierT.random()).get();
      builder.addOutput(fullViewingKey.getOvk(), paymentAddress, AMOLBET, new byte[512]);
      builder.setTransparentOutput(ByteArray.fromHexString(null), AMOLBET);
  ...
  public void publicToShieldAddressAndShieldToPublicAddressWithZoreValueSuccess() {
    ...
    try {
      ...
      Note note = new Note(paymentAddress.getD(), paymentAddress.getPkD(), AMOLBET,
          Note.generateR());
      ...
      Assert.assertEquals(getAssertBalance(accountCapsuleOne),
          ownerAssertBalance - AMOLBET - fee);
    } catch (Exception e) {
      System.out.println(e.getMessage());
      Assert.assertTrue(false);
    }
  ...
  public void shieldToPublicAddressWithZoreValueFailure() {
    dbManager.getDynamicPropertiesStore().saveAllowShieldedTransaction(1);
    dbManager.getDynamicPropertiesStore().saveTotalShieldedPoolValue(AMOLBET * 2);
    long fee = dbManager.getDynamicPropertiesStore().getShieldedTransactionFee();
    ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
    try {
      //From shield address
      ...
      PaymentAddress address = sk.defaultAddress();
      {
        Note note = new Note(address, AMOLBET * 2);
        IncrementalMerkleVoucherContainer voucher = createSimpleMerkleVoucherContainer(note.cm());
        byte[] anchor = voucher.root().getContent().toByteArray();
        dbManager.getMerkleContainer().putMerkleTreeIntoStore(anchor,
            voucher.getVoucherCapsule().getTree());
      ...
      //TO amount
      addZeroValueOutputNote(builder);
      builder.setTransparentOutput(ByteArray.fromHexString(PUBLIC_ADDRESS_TWO), AMOLBET);
      TransactionCapsule transactionCap = builder.build();
  ...
  public void shieldNoteValueWithNagativeToPublicFailure() {
    dbManager.getDynamicPropertiesStore().saveAllowShieldedTransaction(1);
    dbManager.getDynamicPropertiesStore().saveTotalShieldedPoolValue(AMOLBET);
    long fee = dbManager.getDynamicPropertiesStore().getShieldedTransactionFee();
    try {
      ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
      //From shield address
  ...
  public void publicAddressToShieldNoteValueFailure() {
    ...
    try {
      ZenTransactionBuilder builder = new ZenTransactionBuilder(wallet);
      //From amount
      long fromAmount = Long.MAX_VALUE + AMOLBET + fee;
  ...
  public void publicAddressAToShieldAddressFailure() {
    ...
    try {
      ...
      builder.setTransparentOutput(ByteArray.fromHexString(PUBLIC_ADDRESS_ONE), AMOLBET);
  ...
  public void shieldAddressToPublic() {
    ...
    try {
      ...
      builder.setTransparentOutput(ByteArray.fromHexString(addressNotExist), AMOLBET - fee);
