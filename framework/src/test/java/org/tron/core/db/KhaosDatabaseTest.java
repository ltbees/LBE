...
public class KhaosDatabaseTest {
  ...
  public void testPushGetBlock() {
    ...
    } catch (LbeLinkedBlockException | BadNumberBlockException e) {
  ...
  @Test
  public void checkWeakReference() throws LbeLinkedBlockException, BadNumberBlockException {
    BlockCapsule blockCapsule = new BlockCapsule(Block.newBuilder().setBlockHeader(
        BlockHeader.newBuilder().setRawData(raw.newBuilder().setParentHash(ByteString.copyFrom(
            ByteArray
  ...
  public void testGetBranch() {
    ...
    } catch (LbeLinkedBlockException | BadNumberBlockException | NonCommonBlockException e) {
      System.out.println(e.getMessage());
    }
  }
}