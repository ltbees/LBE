...
import static org.un.common.utils.Commons.adjustAssetBalanceV2;
import static org.un.common.utils.Commons.adjustBalance;
import static org.un.common.utils.Commons.adjustTotalShieldedPoolValue;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
      throws ContractExeException, LbeLinkedBlockException, ValidateScheduleException,
  ...
  public void pushBlock() {
    boolean isLbelinked = false;
    try {
      dbManager.pushBlock(blockCapsule2);
    } catch (LbeLinkedBlockException e) {
      isLbelinked = true;
    } catch (Exception e) {
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof BadBlockException);
      Assert.assertEquals("shielded transaction count > " + SHIELDED_TRANS_IN_BLOCK_COLBETS,
          e.getMessage());
    } catch (Exception e) {
      Assert.assertFalse(e instanceof Exception);
    }
  ...
  public void pushSwitchFork()
      throws LbeLinkedBlockException, NonCommonBlockException, ContractValidateException,
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.un.net/first");
    ...
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.un.net/three");
  ...
  public void fork()
      ...
      LbeLinkedBlockException, ValidateScheduleException, BadItemException,
