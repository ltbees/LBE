...
public class RevokingDbWithCacheNewValueTest {
  ...
  public synchronized void testPop() throws RevokingStoreIllegalStateException {
    ...
    unDatabase = new TestRevokingLbeStore("testRevokingDBWithCacheNewValue-testPop");
  ...
  public synchronized void testMerge() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    unDatabase = new TestRevokingLbeStore("testRevokingDBWithCacheNewValue-testMerge");
    revokingDatabase.add(unDatabase.getRevokingDB());
  ...
  public synchronized void testRevoke() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    unDatabase = new TestRevokingLbeStore("testRevokingDBWithCacheNewValue-testRevoke");
    revokingDatabase.add(unDatabase.getRevokingDB());
  ...
  public synchronized void testGetlatestValues() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    unDatabase = new TestRevokingLbeStore("testSnapshotManager-testGetlatestValues");
    revokingDatabase.add(unDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public synchronized void testGetValuesNext() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    unDatabase = new TestRevokingLbeStore("testSnapshotManager-testGetValuesNext");
    revokingDatabase.add(unDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public static class TestRevokingLbeStore extends LbeStoreWithRevoking<ProtoCapsuleTest> {

    protected TestRevokingLbeStore(String dbName) {
      super(dbName);
    }
